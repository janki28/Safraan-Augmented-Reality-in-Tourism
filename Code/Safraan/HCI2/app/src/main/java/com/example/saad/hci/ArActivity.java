package com.example.saad.hci;
        ...
        import static com.mapbox.vision.performance.ModelPerformanceRate.*;
...
public class ArActivity extends BaseActivity implements RouteListener, ProgressChangeListener, OffRouteListener {
    ...
    private final Point ROUTE_ORIGIN = Point.fromLngLat(23.063154, 72.567224);
    //sidi sayeed jail
    private final Point ROUTE_DESTINATION = Point.fromLngLat(23.022833242, 72.575331032);
    private Object LOW;
