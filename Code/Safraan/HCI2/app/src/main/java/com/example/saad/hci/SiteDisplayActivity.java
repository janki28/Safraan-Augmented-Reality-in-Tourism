...
public class SiteDisplayActivity extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Slider
        mDemoSlider = findViewById(R.id.main_slider);
        setupSlider();
    ...
    public void redirectTour(View v) {
        ...
        String gaa=tv.getText().toString();
        String text="Gandhi Ashram";
        if(gaa.equals(text))
        {  gotoUrl("https://www.gandhiheritageportal.org/datalink/files/tour/sabarmatiashram/gandhi-ashram.html");}
        else
        {Toast.makeText(this,"does not",Toast.LENGTH_SHORT).show();}
    }

    private void gotoUrl(String s) {
        Uri uri=Uri.parse(s);
        Intent ga=new Intent(Intent.ACTION_VIEW,uri);
        startActivity(ga);
    }
